...
!function(e){"use strict";var n=function(e,n){setTimeout(function(){e.addClass("loaded")},n)},o=e("body");n(o,150);var t=e("div.image, .projects-feed .project");e.each(t,function(o,t){var i=e(t);i.imagesLoaded(t,function(){n(i,250*o)})}),e(".cd-nav-trigger").on("click",function(n){n.preventDefault(),e("body").toggleClass("navigation-is-open")})}(jQuery);
